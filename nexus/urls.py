...
urlpatterns = [
    ...
    path('ajax/delete/<int:tweet_id>/', views.ajax_delete_tweet, name='ajax_delete_tweet'),
    path('tweet/<int:tweet_id>/update/', views.tweet_update, name='tweet_update'),
    path("notifications/", views.notifications_view, name="notifications"),
    path('ajax/forward/<int:tweet_id>/', views.ajax_forward_tweet, name='ajax_forward_tweet'),
]
